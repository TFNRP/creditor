...
const recurse = async path => {
  ...
  data.createField('name', result.name).verifyType('string', 'undefined');
  ...
  data.createField('gta5-mods', result['gta5-mods']).verifyType('string', 'undefined').verifyUrl('gta5-mods.com');
  await data
